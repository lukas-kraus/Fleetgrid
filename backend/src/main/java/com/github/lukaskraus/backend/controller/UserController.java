...
public class UserController {
    ...
    public MongoUserDTO getUserByUsername(@PathVariable String username) {
        ...
        return new MongoUserDTO(mongoUser.username(), mongoUser.firstname(), mongoUser.lastname(), mongoUser.birthday(), mongoUser.address(), mongoUser.lastLogin(), LocalDateTime.now());
    }
    ...
    public String login() {
        ...
        if (optionalMongoUser.isPresent()) {
            ...
            mongoUser = new MongoUser(mongoUser.id(), mongoUser.username(), mongoUser.password(), mongoUser.firstname(), mongoUser.lastname(), mongoUser.birthday(), mongoUser.address(), mongoUser.newLastLogin(), LocalDateTime.now());
